...
module RakeCommit
  class Git
    ...
    def initialize(build_command, collapse_commits = true, rebase_only = false, incremental = false, prompt_exclusions = [], precommit = nil, use_editor = false)
    ...
    def incremental_commit
      ...
      if @use_editor
        RakeCommit::Shell.system("git commit -v")
      else
